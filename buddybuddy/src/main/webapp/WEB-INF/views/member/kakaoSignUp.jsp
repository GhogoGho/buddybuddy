...
<head>
    ...
    <style>
       ...
       /* 카카오 회원가입 알림 폼*/
        ...
        .kakaoSignUp-form .form-group {
            margin-bottom: 20px;
        }

        .kakaoSignUp-form label {
            font-weight: normal;
            font-size: 13px;
            line-height: 40px;
        }

        .kakaoSignUp-form input[type="checkbox"] {
            margin-top: 2px;
        }

        .kakaoSignUp-form .btn {
            font-size: 16px;
            font-weight: bold;
            background: #50b8b3;
            border: none;
        ...
        .kakaoSignUp-form .btn:hover,
        .kakaoSignUp-form .btn:focus {
            background: #50b8b3;
            outline: none !important;
        }
        
         .kakaoSignUp-form .btn1:hover,
        .kakaoSignUp-form .btn1:focus {
            background: #50b8b3;
            outline: none !important;
        }

        .kakaoSignUp-form-form a {
            color: #50b8b3;
            text-decoration: none;
        }

        .kakaoSignUp-form a:hover {
            text-decoration: none;
        }
...
<body>
    ...
    <!-- 컨테이너 입력 부분 -->
    <!-- ID 찾기 -->
    <div class="kakaoSignUp-form">
        <form action="kakaoSignUp" method="post" class="form-horizontal">
            <div class="col-xs-8 col-xs-offset-4">
                <h2>ID 찾기</h2>
            </div>

            <div class="form-group">
               <h3> 가입된 회원이 존재하지 않습니다. <br>
                    회원 가입 후 이용하시겠습니까?</h3>
            </div>
            ...
            <div class="form-group">
                <div class="col-xs-8 col-xs-offset-4">
                    <button type="submit" class="btn btn-primary btn-lg data-toggle=">회원 가입</button>
                    <button type="button" class="btn1 btn-primary btn-lg"><a href="${contextPath}/main">돌아가기</a></button>
                </div>
            </div>
