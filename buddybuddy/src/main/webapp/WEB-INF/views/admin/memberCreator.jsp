...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">크리에이터 승인</h1>
					<ol class="breadcrumb mb-4"></ol>
				
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 크리에이터 관리
						</div>
						<div class="card-body">
							<table id="datatablesSimple"  class="table table-dark table-hover" >
								...
								<tbody>
									...
									<c:forEach items="${memberCreatorList}" var="member">
										...
										<tr>
											...
											<td>
												<button type="button" class="btn btn-success" value="${member.memberNo}" onclick="confirm(this);">승인</button>
												<%-- <button type="button" class="btn btn-info" value="${member.memberNo}" onclick="cancel();">취소</button> --%>
											</td>
										</tr>
    ...
    function confirm(e){
    	...
    	const memberNo = $(e).val();
    	 ...
    	 $.ajax({
    	      url : "${contextPath}/admin/memberGradeUpdate",
    	      type : "POST",
    	      data : {"memberNo" : memberNo},
    	      success : function(result){
    	         
    	         if(result > 0){
    	            location.href = "${contextPath}/admin/memberCreator";
    	         }
    	      },
    	      error : function(){
    	      }
