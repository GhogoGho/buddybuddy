      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
          <video id="class-video"
            src="https://cdn.videvo.net/videvo_files/video/premium/video0227/large_watermarked/08_Den_Darina_maldiv_25_walk_alone_preview.mp4"
            type="video/mp4" style="width: 80rem; height: 30rem;" controls>
            동영상
          </video>
          <hr>
          <!-- 네이게이션 메뉴 -->
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-list" role="tabpanel" aria-labelledby="pills-list-tab">
              <div class="col-md-12">
                <p class="h3 my-4" id="class-list">총 ${classCount}개의 강좌</p>
                <hr>
                <ul class="class-list-content list-group col-md-12">
                  <li class="list-group-item">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <img
                          src="https://images.unsplash.com/photo-1522196772883-393d879eb14d?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjN8fHByb2ZpbGV8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
                          width="200" height="200" class="user-image me-2">
                      </div>
                      <div class="col-md-9">
                    ...
                    <div class="row">
                      <div class="col-md-1 offset-md-11 my-1">
                        <button class="btn btn-success btn-lg" id="btn-play">
                          재생
                        </button>
                      </div>
                      <div class="progress">
                  ...
                  <li class="list-group-item">
                    ...
                    <div class="row">
                      <div id="btn-play" class="col-md-1 offset-md-11 my-1">
                        <button class="btn btn-success btn-lg" id="btn-play">
                          재생
                        </button>
                      </div>
...
<script>
  ...
  $(function () {
    $('#btn-play').click(function () {
      ...
      video.attr({ 'src': 'https://cdn.videvo.net/videvo_files/video/premium/video0227/large_watermarked/08_Den_Darina_maldiv_25_walk_alone_preview.mp4' });
      video.get(0).play();
    });
  });
