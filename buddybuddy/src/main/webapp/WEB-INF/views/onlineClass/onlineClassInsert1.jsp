...
<body>
		...
		<div class="container my-5">
			...
			<form action="insert" method="post"  enctype="multipart/form-data" role="form" onsubmit="return classValidate();">
				...
				<div class="form-inline mb-2">
					...
					<input type="text" class="form-control" id="classTitle" name="classTitle" size="70">
				</div>

				<div class="form-inline mb-2">
					<label class="input-group-addon mr-3 insert-label">작성자</label>
					<h5 class="my-0" id="writer">${loginMember.memberNickname }</h5>
				</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="classContent" name="classContent" rows="15" style="resize: none;"></textarea>
				</div>
