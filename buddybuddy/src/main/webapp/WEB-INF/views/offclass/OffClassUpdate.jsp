		...
		<div class="container">
			...
			<div class="row">
					<c:if test="${!empty category}">
						...
						style="font-size: 20px;" id="categoryCode" name="categoryCode">
				...
				<div class="col-md-12 mb-3">
					<label style="font-size: 25px;">제목 : </label> <input
						...
						style="width: 90%; display: inline-block;" value="${offList.classTitle}" required>
				</div>
				<div class="col-md-12 mb-3">
					<label style="font-size: 25px;">가격 : </label> <input
						name="classPrice" type="text" class="form-control"
						style="width: 15%; display: inline-block;" value="${offList.classPrice}" required>
				</div>
				<div class="col-md-12 mb-3">
				...
				<div id="reserveArea" class="col-md-12 mb-3">
				...
				<div class="col-md-12 mb-3">
					<textarea class="summernote" name="editordata" required>${offList.classContent}</textarea>
